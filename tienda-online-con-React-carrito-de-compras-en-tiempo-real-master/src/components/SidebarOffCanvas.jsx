...
const SidebarOffCanvas = () => {
  ...
  const { isVisible, toggleOffcanvas } = useOffcanvasStore(); // Cambiamos setIsVisible por toggleOffcanvas
  ...
  return (
    <div
      ...
      style={{ display: isVisible ? "block" : "none" }} // Agregamos display style
    >
      <div className="offcanvas-header">
        ...
        <button
          type="button"
          className="btn-close"
          onClick={toggleOffcanvas} // Cambiamos a toggleOffcanvas
          aria-label="Close"
        ></button>
      </div>
